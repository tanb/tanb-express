...
When we want to write a link in Angular templates, then we usually use RouterLink. For example, if you want this link **"/user/1/bookmark/1234/detail"** in a templates, you might write useing [RouterLink](https://angular.io/api/router/RouterLink) as follows:
